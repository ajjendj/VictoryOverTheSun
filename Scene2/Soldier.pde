class Soldier {
  ...
  public Soldier(String filename, int x, int y, float scale, int alpha, boolean randomize)
  {
  ...
  void drawSkeleton()
  {
    ...
    //draw head
    pushMatrix();
    translate(skeleton[3][0], skeleton[3][1]);
    rotate(radians(45));
    translate(-skeleton[3][0], -skeleton[3][1]);
    rectMode(CENTER);
    fill(255,51,51);
    rect(skeleton[3][0], skeleton[3][1],(int)(45*scale),(int)(45*scale));
    popMatrix();
    ellipseMode(CENTER);
    fill(255,51,51,alpha);
    ...
    stroke(255,51,51,alpha);
    ellipse(skeleton[7][0], skeleton[7][1], (int)(10*scale), (int)(8*scale));
    line(skeleton[7][0], skeleton[7][1], skeleton[7][0], skeleton[7][1] - 100);
    ...
    strokeWeight(3);
    beginShape();
    vertex(skeleton[12][0]-(int)(20*scale), skeleton[12][1]-(int)(30*scale));
    vertex(skeleton[16][0]+(int)(20*scale), skeleton[16][1]-(int)(30*scale));
    vertex(skeleton[17][0]+(int)(40*scale), skeleton[17][1]-(int)(100*scale));
    vertex(skeleton[13][0]-(int)(40*scale), skeleton[13][1]-(int)(100*scale));
    vertex(skeleton[12][0]-(int)(20*scale), skeleton[12][1]-(int)(30*scale));
    endShape();
