class Gravedigger {
  ...
  public Gravedigger(String filename, int x, int y, float scale, int alpha, boolean mirror)
  {
  ...
  void drawSkeleton()
  {
    ...
    //draw hat
    fill(204,102,0,alpha);
    rectMode(CENTER);
    rect(skeleton[3][0], skeleton[3][1]-20, 40,10);
    rect(skeleton[3][0], skeleton[3][1]-30, 30,30);
 
    //draw torso
    fill(200,200,200,alpha);
    strokeCap(PROJECT);
    strokeWeight((int)(3*scale));
    rect(skeleton[1][0], skeleton[1][1], 60, 90);
    fill(0,0,0,alpha);
    ...
    vertex(skeleton[17][0]+(int)(40*scale), skeleton[17][1]+(int)(20*scale));
    vertex(skeleton[13][0]-(int)(40*scale), skeleton[13][1]+(int)(20*scale));
    vertex(skeleton[12][0]-(int)(10*scale), skeleton[12][1]-(int)(10*scale));
    endShape();
